...
import github.why168.dimesn_sw_lib.DimenTypes;

/**
 * MakeUtils
 *
 * @author Edwin.Wu edwin.wu05@gmail.com
 * @version 2020/5/2 2:44 PM
 * @since JDK1.8
 */
public class MakeUtils {
    ...
    private static final String XML_UN_DIMEN_TEMPLETE = "\t<dimen name=\"un_qb_%1$spx_%2$d\">%3$.2fdp</dimen>\r\n";
    ...
    private static String makeAllDimens(DimenTypes type, int designWidth) {
        ...
        try {
            ...
            for (int i = 0; i <= MAX_SIZE; i++) {
                dpValue = px2dip((float) i, type.getSwWidthDp(), designWidth);
                temp = String.format(XML_UN_DIMEN_TEMPLETE, "", i, -dpValue);
                sb.append(temp);
            }
