 ...
 * @since JDK1.8
 */
public class TasksDBPresenter implements TasksContract.Presenter {
    private final FakeTasksRemoteDataSource mTasksRepository;
    private final TasksContract.View mTasksView;
    private TasksFilterType mCurrentFiltering = ALL_TASKS;
    private boolean mFirstLoad = true;

    public TasksDBPresenter(FakeTasksRemoteDataSource tasksRepository, TasksContract.View tasksView) {
