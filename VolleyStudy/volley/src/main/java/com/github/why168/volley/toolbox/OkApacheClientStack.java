...
/**
 * An HttpStack that performs request over an {@link OkApacheClient}.
 *
 * @author Edwin.Wu
 * @version 2017/3/1$ 13:32$
 * @since JDK1.8
 */
public class OkApacheClientStack implements HttpStack {
    protected final OkApacheClient mClient;

    private final static String HEADER_CONTENT_TYPE = "Content-Type";

    public OkApacheClientStack(OkApacheClient client) {
        mClient = client;
    }
